...
VALUES
    ...
    ('Task 4', 1, 'Memo for Task 4', DATEADD(DAY, 0, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, '매년', true, false),
    ('Task 5', 1, 'Memo for Task 5', DATEADD(DAY, 0, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, '없음', true, false),
    ('Task 6', 1, 'Memo for Task 6', DATEADD(DAY, 1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, '매일', true, false),
    ('Task 7', 1, 'Memo for Task 7', DATEADD(DAY, 2, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, '매주', false, false),
    ('Task 8', 1, 'Memo for Task 8', DATEADD(DAY, 3, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, '매월', true, false),
