...
VALUES
    ...
    ('Task 6', 1, 'Memo for Task 6', DATEADD(DAY, 1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, '매일', false, false),
    ('Task 7', 1, 'Memo for Task 7', DATEADD(DAY, 2, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, '매주', false, false),
    ('Task 8', 1, 'Memo for Task 8', DATEADD(DAY, 3, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, '매월', false, false),
    ('Task 9', 1, 'Memo for Task 9', DATEADD(DAY, 4, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, '매년', false, false),
